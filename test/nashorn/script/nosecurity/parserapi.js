...
// Java types used
Parser.Diagnostic = Java.type("io.sqreen.nashorn.api.tree.Diagnostic");
Parser.SimpleTreeVisitor = Java.type("io.sqreen.nashorn.api.tree.SimpleTreeVisitorES5_1");
Parser.Tree = Java.type("io.sqreen.nashorn.api.tree.Tree");
...
Parser.create = function() {
    return Java.type("io.sqreen.nashorn.api.tree.Parser").create();
}
