 ...
 * check if jjs version is same as of that of the io.sqreen.nashorn that of the io.sqreen.nashorn module.
 * @test
 * @option -scripting
 * @run
...
var nashornMod = java.lang.ModuleLayer.boot().findModule("io.sqreen.nashorn").get();
var nashornVersion = nashornMod.descriptor.version().get();

// code to check -flag
var msg_flag = 'var x = "Hello Nashorn"'

// flag test expected output variables
var e_outp = "nashorn ${nashornVersion}"
