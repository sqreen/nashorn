...
var NashornFactory = new (Java.type('io.sqreen.nashorn.api.scripting.NashornScriptEngineFactory'))(),
...
var script = <<EOS
    var F = new (Java.type('io.sqreen.nashorn.api.scripting.NashornScriptEngineFactory'))(),
