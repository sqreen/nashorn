...
var asmJar = new File(System.getProperty("asm.jar"));
if (! asmJar.isAbsolute()) {
	fail("Expected absolute asm.jar");
}
...
`${jdepsPath} --module-path=${asmJar} -s -P ${nashornJar.absolutePath}`
