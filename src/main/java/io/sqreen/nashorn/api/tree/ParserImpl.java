...
final class ParserImpl implements Parser {
    ...
    private io.sqreen.nashorn.internal.parser.Parser makeParser(final Source source, final DiagnosticListener listener) {
        final ErrorManager errMgr = listener != null ? new ListenerErrorManager(listener) : new Context.ThrowErrorManager();
        return new io.sqreen.nashorn.internal.parser.Parser(env, source, errMgr);
    }
