...
import io.sqreen.nashorn.internal.codegen.CompileUnit;
...
import io.sqreen.nashorn.internal.runtime.UserAccessorProperty;
...
public final class FunctionNode extends LexicalContextExpression implements Flags<FunctionNode>, CompileUnitHolder {
    ...
    public int getCallSiteFlags() {
        ...
        if (getFlag(IS_STRICT)) {
            callsiteFlags |= NashornCallSiteDescriptor.CALLSITE_STRICT;
        }
        ...
        if (getDebugFlag(DEBUG_TRACE_MISSES)) {
            callsiteFlags |= NashornCallSiteDescriptor.CALLSITE_TRACE | NashornCallSiteDescriptor.CALLSITE_TRACE_MISSES;
        }

        if (getDebugFlag(DEBUG_TRACE_VALUES)) {
            callsiteFlags |= NashornCallSiteDescriptor.CALLSITE_TRACE | NashornCallSiteDescriptor.CALLSITE_TRACE_ENTEREXIT | NashornCallSiteDescriptor.CALLSITE_TRACE_VALUES;
        }

        if (getDebugFlag(DEBUG_TRACE_ENTEREXIT)) {
            callsiteFlags |= NashornCallSiteDescriptor.CALLSITE_TRACE | NashornCallSiteDescriptor.CALLSITE_TRACE_ENTEREXIT;
        }
