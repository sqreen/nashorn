...
public final class IdentNode extends Expression implements PropertyKey, FunctionCall, Optimistic, JoinPredecessor {
    ...
    public IdentNode(final long token, final int finish, final String name) {
        ...
        this.type = null;
        this.flags = 0;
        this.programPoint = UnwarrantedOptimismException.INVALID_PROGRAM_POINT;
    ...
    public boolean isCompileTimePropertyName() {
        return name.equals(CompilerConstants.__DIR__.symbolName()) || name.equals(CompilerConstants.__FILE__.symbolName()) || name.equals(CompilerConstants.__LINE__.symbolName());
    }
