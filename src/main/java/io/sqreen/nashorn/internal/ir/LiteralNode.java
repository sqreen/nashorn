...
package io.sqreen.nashorn.internal.ir;
...
import io.sqreen.nashorn.internal.ir.annotations.Ignore;
import io.sqreen.nashorn.internal.ir.annotations.Immutable;
import io.sqreen.nashorn.internal.ir.visitor.NodeVisitor;
import io.sqreen.nashorn.internal.objects.NativeArray;
import io.sqreen.nashorn.internal.parser.Lexer.LexerToken;
...
public abstract class LiteralNode<T> extends Expression implements PropertyKey {
    ...
    public static class PrimitiveLiteralNode<T> extends LiteralNode<T> {
        ...
        private PrimitiveLiteralNode(final io.sqreen.nashorn.internal.ir.LiteralNode.PrimitiveLiteralNode<T> literalNode) {
            super(literalNode);
        }
    ...
    private static final class BooleanLiteralNode extends PrimitiveLiteralNode<Boolean> {
        ...
        private BooleanLiteralNode(final io.sqreen.nashorn.internal.ir.LiteralNode.BooleanLiteralNode literalNode) {
            super(literalNode);
        }
    ...
    private static final class NumberLiteralNode extends PrimitiveLiteralNode<Number> {
        ...
        private NumberLiteralNode(final io.sqreen.nashorn.internal.ir.LiteralNode.NumberLiteralNode literalNode) {
            super(literalNode);
        }
    ...
    private static class UndefinedLiteralNode extends PrimitiveLiteralNode<Undefined> {
        ...
        private UndefinedLiteralNode(final io.sqreen.nashorn.internal.ir.LiteralNode.UndefinedLiteralNode literalNode) {
            super(literalNode);
        }
    }
    ...
    private static class StringLiteralNode extends PrimitiveLiteralNode<String> {
        ...
        private StringLiteralNode(final io.sqreen.nashorn.internal.ir.LiteralNode.StringLiteralNode literalNode) {
            super(literalNode);
        }
    ...
    private static class LexerTokenLiteralNode extends LiteralNode<LexerToken> {
        ...
        private LexerTokenLiteralNode(final io.sqreen.nashorn.internal.ir.LiteralNode.LexerTokenLiteralNode literalNode) {
            super(literalNode);
        }
    ...
    public static final class ArrayLiteralNode extends LiteralNode<Expression[]> implements LexicalContextNode, Splittable {
        ...
        private static final class ArrayLiteralInitializer {
            ...
            static io.sqreen.nashorn.internal.ir.LiteralNode.ArrayLiteralNode initialize(final io.sqreen.nashorn.internal.ir.LiteralNode.ArrayLiteralNode node) {
                ...
                return new io.sqreen.nashorn.internal.ir.LiteralNode.ArrayLiteralNode(node, node.value, elementType, postsets, presets, node.splitRanges);
            }
            ...
            private static int[] computePostsets(final Expression[] value) {
                ...
                for (int i = 0; i < value.length; i++) {
                    ...
                    if (element == null || !io.sqreen.nashorn.internal.ir.LiteralNode.isConstant(element)) {
            ...
            private static int[] presetIntArray(final Expression[] value, final int[] postsets) {
                ...
                int nComputed = 0;
                for (int i = 0; i < value.length; i++) {
                    if (!setArrayElement(array, i, io.sqreen.nashorn.internal.ir.LiteralNode.objectAsConstant(value[i]))) {
            ...
            private static Object[] presetObjectArray(final Expression[] value, final int[] postsets) {
                ...
                for (int i = 0; i < value.length; i++) {
                    ...
                    final Object element = io.sqreen.nashorn.internal.ir.LiteralNode.objectAsConstant(node);

                    if (element != io.sqreen.nashorn.internal.ir.LiteralNode.POSTSET_MARKER) {
                        array[i] = element;
                    } else {
                        assert postsets[nComputed++] == i;
                    }
         ...
         */
        private ArrayLiteralNode(final io.sqreen.nashorn.internal.ir.LiteralNode.ArrayLiteralNode node, final Expression[] value, final Type elementType, final int[] postsets, final Object presets, final List<SplitRange> splitRanges) {
            super(node, value);
         ...
         */
        @Override
        public io.sqreen.nashorn.internal.ir.LiteralNode.ArrayLiteralNode initialize(final LexicalContext lc) {
         ...
         */
        public io.sqreen.nashorn.internal.ir.LiteralNode.ArrayLiteralNode setSplitRanges(final LexicalContext lc, final List<Splittable.SplitRange> splitRanges) {
            if (this.splitRanges == splitRanges) {
                return this;
            }
            return Node.replaceInLexicalContext(lc, this, new io.sqreen.nashorn.internal.ir.LiteralNode.ArrayLiteralNode(this, value, elementType, postsets, presets, splitRanges));
        }
        ...
        private io.sqreen.nashorn.internal.ir.LiteralNode.ArrayLiteralNode setValue(final LexicalContext lc, final Expression[] value) {
            if (this.value == value) {
                return this;
            }
            return Node.replaceInLexicalContext(lc, this, new io.sqreen.nashorn.internal.ir.LiteralNode.ArrayLiteralNode(this, value, elementType, postsets, presets, splitRanges));
        ...
        private io.sqreen.nashorn.internal.ir.LiteralNode.ArrayLiteralNode setValue(final LexicalContext lc, final List<Expression> value) {
