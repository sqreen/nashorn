...
import static io.sqreen.nashorn.internal.runtime.ECMAErrors.rangeError;
...
import static io.sqreen.nashorn.internal.runtime.arrays.ArrayLikeIterator.arrayLikeIterator;
import static io.sqreen.nashorn.internal.runtime.arrays.ArrayLikeIterator.reverseArrayLikeIterator;
import static io.sqreen.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_STRICT;
...
import io.sqreen.nashorn.internal.objects.annotations.Constructor;
import io.sqreen.nashorn.internal.objects.annotations.Function;
...
import io.sqreen.nashorn.internal.objects.annotations.SpecializedFunction;
import io.sqreen.nashorn.internal.objects.annotations.SpecializedFunction.LinkLogic;
import io.sqreen.nashorn.internal.objects.annotations.Where;
...
import io.sqreen.nashorn.internal.runtime.OptimisticBuiltins;
...
import io.sqreen.nashorn.internal.runtime.arrays.ContinuousArrayData;
import io.sqreen.nashorn.internal.runtime.arrays.IntElements;
import io.sqreen.nashorn.internal.runtime.arrays.IteratorAction;
import io.sqreen.nashorn.internal.runtime.arrays.NumericElements;
...
public final class NativeArray extends ScriptObject implements OptimisticBuiltins {
    ...
    private static final class ConcatLinkLogic extends ArrayLinkLogic {
        ...
        public boolean canLink(final Object self, final CallSiteDescriptor desc, final LinkRequest request) {
            ...
            final ContinuousArrayData selfData = io.sqreen.nashorn.internal.objects.NativeArray.ArrayLinkLogic.getContinuousArrayData(self);
            if (selfData == null) {
                return false;
            }
            ...
            if (arg instanceof NativeArray) {
                return (io.sqreen.nashorn.internal.objects.NativeArray.ArrayLinkLogic.getContinuousArrayData(arg) != null);
            }
    ...
    private static final class PushLinkLogic extends ArrayLinkLogic {
        ...
        @Override
        public boolean canLink(final Object self, final CallSiteDescriptor desc, final LinkRequest request) {
            return io.sqreen.nashorn.internal.objects.NativeArray.ArrayLinkLogic.getContinuousArrayData(self) != null;
        }
    }
    ...
    private static final class PopLinkLogic extends ArrayLinkLogic {
        ...
        private static ContinuousArrayData getContinuousNonEmptyArrayData(final Object self) {
            final ContinuousArrayData data = io.sqreen.nashorn.internal.objects.NativeArray.ArrayLinkLogic.getContinuousArrayData(self);
            if (data != null) {
