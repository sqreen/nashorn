...
import io.sqreen.nashorn.internal.runtime.arrays.TypedArrayData;
...
public final class NativeUint8ClampedArray extends ArrayBufferView {
    ...
    private static final class Uint8ClampedArrayData extends TypedArrayData<ByteBuffer> {
        ...
        private static final MethodHandle GET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Uint8ClampedArrayData.class, "getElem", int.class, int.class).methodHandle();
        private static final MethodHandle SET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Uint8ClampedArrayData.class, "setElem", void.class, int.class, int.class).methodHandle();
        private static final MethodHandle RINT_D   = CompilerConstants.staticCall(MethodHandles.lookup(), Uint8ClampedArrayData.class, "rint", double.class, double.class).methodHandle();
