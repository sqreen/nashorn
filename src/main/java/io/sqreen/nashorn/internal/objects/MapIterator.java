...
public class MapIterator extends AbstractIterator {
     ...
     */
    MapIterator(final NativeMap map, final AbstractIterator.IterationKind iterationKind, final Global global) {
    ...
    protected IteratorResult next(final Object arg) {
        ...
        return makeResult(iterationKind == AbstractIterator.IterationKind.KEY ? node.getKey() : node.getValue(), Boolean.FALSE, global);
    }
