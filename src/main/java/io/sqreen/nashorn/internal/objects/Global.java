...
package io.sqreen.nashorn.internal.objects;
...
import static io.sqreen.nashorn.internal.runtime.JSType.isString;
...
import io.sqreen.nashorn.internal.runtime.GlobalFunctions;
import io.sqreen.nashorn.internal.runtime.ScriptingFunctions;
import jdk.dynalink.CallSiteDescriptor;
import jdk.dynalink.linker.GuardedInvocation;
import jdk.dynalink.linker.LinkRequest;
import io.sqreen.nashorn.api.scripting.ClassFilter;
import io.sqreen.nashorn.api.scripting.ScriptObjectMirror;
import io.sqreen.nashorn.internal.objects.annotations.Attribute;
import io.sqreen.nashorn.internal.objects.annotations.Getter;
import io.sqreen.nashorn.internal.objects.annotations.Property;
import io.sqreen.nashorn.internal.objects.annotations.ScriptClass;
import io.sqreen.nashorn.internal.objects.annotations.Setter;
import io.sqreen.nashorn.internal.runtime.Context;
import io.sqreen.nashorn.internal.runtime.ECMAErrors;
import io.sqreen.nashorn.internal.runtime.FindProperty;
import io.sqreen.nashorn.internal.runtime.GlobalConstants;
import io.sqreen.nashorn.internal.runtime.JSType;
import io.sqreen.nashorn.internal.runtime.NativeJavaPackage;
import io.sqreen.nashorn.internal.runtime.PropertyDescriptor;
...
import io.sqreen.nashorn.internal.runtime.Specialization;
import io.sqreen.nashorn.internal.runtime.Symbol;
import io.sqreen.nashorn.internal.runtime.arrays.ArrayData;
import io.sqreen.nashorn.internal.runtime.linker.Bootstrap;
import io.sqreen.nashorn.internal.runtime.linker.InvokeByName;
import io.sqreen.nashorn.internal.runtime.linker.NashornCallSiteDescriptor;
import io.sqreen.nashorn.internal.runtime.regexp.RegExpResult;
import io.sqreen.nashorn.internal.scripts.JD;
import io.sqreen.nashorn.internal.scripts.JO;
import io.sqreen.nashorn.tools.ShellFunctions;
...
public final class Global extends Scope {
    ...
    private static final String PACKAGE_PREFIX = "io.sqreen.nashorn.internal.objects.";
    ...
    @Override
    public void addBoundProperties(final ScriptObject source, final io.sqreen.nashorn.internal.runtime.Property[] properties) {
        ...
        if (context.getEnv()._es6) {
            ...
            for (final io.sqreen.nashorn.internal.runtime.Property property : properties) {
                if (property.isLexicalBinding()) {
                    hasLexicalDefinitions = true;
                }
                // ES6 15.1.8 steps 6. and 7.
                final io.sqreen.nashorn.internal.runtime.Property globalProperty = ownMap.findProperty(property.getKey());
                ...
                final io.sqreen.nashorn.internal.runtime.Property lexicalProperty = lexicalMap.findProperty(property.getKey());
    ...
    private List<io.sqreen.nashorn.internal.runtime.Property> extractBuiltinProperties(final String name, final ScriptObject func) {
        final List<io.sqreen.nashorn.internal.runtime.Property> list = new ArrayList<>();
        ...
        final io.sqreen.nashorn.internal.runtime.Property prop = getProperty(name);
        if (prop != null) {
            list.add(prop);
        }
    ...
    private void tagBuiltinProperties(final String name, final ScriptObject func) {
        ...
        for (final io.sqreen.nashorn.internal.runtime.Property prop : extractBuiltinProperties(name, func)) {
    ...
    private void initFunctionAndObject() {
        ...
        io.sqreen.nashorn.internal.runtime.Property[] properties = getFunctionPrototype().getMap().getProperties();
        for (final io.sqreen.nashorn.internal.runtime.Property property : properties) {
        ...
        for (final io.sqreen.nashorn.internal.runtime.Property property : builtinObject.getMap().getProperties()) {
            final Object key = property.getKey();
    ...
    private static class LexicalScope extends ScriptObject {
        ...
        @Override
        protected PropertyMap addBoundProperty(final PropertyMap propMap, final ScriptObject source, final io.sqreen.nashorn.internal.runtime.Property property, final boolean extensible) {
