...
public final class NativeInt16Array extends ArrayBufferView {
    ...
    private static final class Int16ArrayData extends TypedArrayData<ShortBuffer> {
        ...
        private static final MethodHandle GET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Int16ArrayData.class, "getElem", int.class, int.class).methodHandle();
        private static final MethodHandle SET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Int16ArrayData.class, "setElem", void.class, int.class, int.class).methodHandle();
