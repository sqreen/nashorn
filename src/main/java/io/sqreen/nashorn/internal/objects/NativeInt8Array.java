...
public final class NativeInt8Array extends ArrayBufferView {
    ...
    private static final class Int8ArrayData extends TypedArrayData<ByteBuffer> {
        ...
        private static final MethodHandle GET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Int8ArrayData.class, "getElem", int.class, int.class).methodHandle();
        private static final MethodHandle SET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Int8ArrayData.class, "setElem", void.class, int.class, int.class).methodHandle();
