...
public class ArrayIterator extends AbstractIterator {
    ...
    private ArrayIterator(final Object iteratedObject, final AbstractIterator.IterationKind iterationKind, final Global global) {
    ...
    protected IteratorResult next(final Object arg) {
        ...
        if (iterationKind == AbstractIterator.IterationKind.KEY_VALUE) {
        ...
        final Object value = iterationKind == AbstractIterator.IterationKind.KEY ?
