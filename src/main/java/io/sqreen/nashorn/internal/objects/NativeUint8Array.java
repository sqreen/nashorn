...
public final class NativeUint8Array extends ArrayBufferView {
    ...
    private static final class Uint8ArrayData extends TypedArrayData<ByteBuffer> {
        ...
        private static final MethodHandle GET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Uint8ArrayData.class, "getElem", int.class, int.class).methodHandle();
        private static final MethodHandle SET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Uint8ArrayData.class, "setElem", void.class, int.class, int.class).methodHandle();
