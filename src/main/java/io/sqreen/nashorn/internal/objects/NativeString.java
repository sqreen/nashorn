...
import io.sqreen.nashorn.internal.runtime.ConsString;
...
import io.sqreen.nashorn.internal.runtime.linker.PrimitiveLookup;
...
public final class NativeString extends ScriptObject implements OptimisticBuiltins {
    ...
    static final MethodHandle WRAPFILTER = findOwnMH("wrapFilter", Lookup.MH.type(NativeString.class, Object.class));
