...
import static io.sqreen.internal.org.objectweb.asm.Opcodes.DALOAD;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.DASTORE;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.DUP;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.DUP2;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.DUP2_X1;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.DUP2_X2;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.DUP_X1;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.DUP_X2;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.IALOAD;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.IASTORE;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.INVOKESTATIC;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.LALOAD;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.LASTORE;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.NEWARRAY;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.POP;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.POP2;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.SWAP;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.T_DOUBLE;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.T_INT;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.T_LONG;
...
public abstract class Type implements Comparable<Type>, BytecodeOps, Serializable {
     ...
     */
    private static final Map<Class<?>, io.sqreen.internal.org.objectweb.asm.Type> INTERNAL_TYPE_CACHE =
            Collections.synchronizedMap(new WeakHashMap<Class<?>, io.sqreen.internal.org.objectweb.asm.Type>());

    /** Internal ASM type for this Type - computed once at construction */
    private transient final io.sqreen.internal.org.objectweb.asm.Type internalType;
    ...
    Type(final String name, final Class<?> clazz, final int weight, final int slots) {
        this.name         = name;
        this.clazz        = clazz;
        this.descriptor   = io.sqreen.internal.org.objectweb.asm.Type.getDescriptor(clazz);
        this.weight       = weight;
    ...
    public static String getMethodDescriptor(final Type returnType, final Type... types) {
        final io.sqreen.internal.org.objectweb.asm.Type[] itypes = new io.sqreen.internal.org.objectweb.asm.Type[types.length];
        for (int i = 0; i < types.length; i++) {
            itypes[i] = types[i].getInternalType();
        }
        return io.sqreen.internal.org.objectweb.asm.Type.getMethodDescriptor(returnType.getInternalType(), itypes);
    }
    ...
    public static String getMethodDescriptor(final Class<?> returnType, final Class<?>... types) {
        ...
        return io.sqreen.internal.org.objectweb.asm.Type.getMethodDescriptor(getInternalType(returnType), itypes);
    }
    ...
    private static Type typeFor(final io.sqreen.internal.org.objectweb.asm.Type itype) {
        switch (itype.getSort()) {
        case io.sqreen.internal.org.objectweb.asm.Type.BOOLEAN:
            return BOOLEAN;
        case io.sqreen.internal.org.objectweb.asm.Type.INT:
            return INT;
        case io.sqreen.internal.org.objectweb.asm.Type.LONG:
            return LONG;
        case io.sqreen.internal.org.objectweb.asm.Type.DOUBLE:
            return NUMBER;
        case io.sqreen.internal.org.objectweb.asm.Type.OBJECT:
        ...
        case io.sqreen.internal.org.objectweb.asm.Type.VOID:
            return null;
        case io.sqreen.internal.org.objectweb.asm.Type.ARRAY:
    ...
    public static Type getMethodReturnType(final String methodDescriptor) {
        return Type.typeFor(io.sqreen.internal.org.objectweb.asm.Type.getReturnType(methodDescriptor));
    }
    ...
    public static Type[] getMethodArguments(final String methodDescriptor) {
        final io.sqreen.internal.org.objectweb.asm.Type itypes[] = io.sqreen.internal.org.objectweb.asm.Type.getArgumentTypes(methodDescriptor);
    ...
    static io.sqreen.internal.org.objectweb.asm.Type getInternalType(final String className) {
        return io.sqreen.internal.org.objectweb.asm.Type.getType(className);
    }

    private io.sqreen.internal.org.objectweb.asm.Type getInternalType() {
        return internalType;
    }

    private static io.sqreen.internal.org.objectweb.asm.Type lookupInternalType(final Class<?> type) {
        final Map<Class<?>, io.sqreen.internal.org.objectweb.asm.Type> c = INTERNAL_TYPE_CACHE;
        io.sqreen.internal.org.objectweb.asm.Type itype = c.get(type);
        if (itype != null) {
            return itype;
        }
        itype = io.sqreen.internal.org.objectweb.asm.Type.getType(type);
        c.put(type, itype);
        return itype;
    }

    private static io.sqreen.internal.org.objectweb.asm.Type getInternalType(final Class<?> type) {
    ...
    public String getInternalName() {
        return io.sqreen.internal.org.objectweb.asm.Type.getInternalName(getTypeClass());
    }
    ...
    public static String getInternalName(final Class<?> clazz) {
        return io.sqreen.internal.org.objectweb.asm.Type.getInternalName(clazz);
    }
     ...
     * (either a {@code java.lang.String} or {@code io.sqreen.nashorn.internal.runtime.ConsString}.
     */
    ...
    private abstract static class ValueLessType extends Type {
        ...
        ValueLessType(final String name) {
            super(name, io.sqreen.nashorn.internal.codegen.types.Type.Unknown.class, io.sqreen.nashorn.internal.codegen.types.Type.MIN_WEIGHT, 1);
        }
