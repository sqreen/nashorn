...
import static io.sqreen.nashorn.internal.ir.Expression.isAlwaysTrue;
...
import io.sqreen.nashorn.internal.parser.Token;
...
import io.sqreen.nashorn.internal.ir.BlockLexicalContext;
...
final class Lower extends NodeOperatorVisitor<BlockLexicalContext> implements Loggable {
                ...
                node = expressionStatement.setExpression(
                    new BinaryNode(
                        Token.recast(
                            ...
                            TokenType.ASSIGN),
                        compilerConstant(CompilerConstants.RETURN),
                    expr));
            }
        }
    ...
    public boolean enterForNode(final ForNode forNode) {
        if (es6 && (forNode.getInit() instanceof ObjectNode || forNode.getInit() instanceof LiteralNode.ArrayLiteralNode)) {
    ...
    public boolean enterASSIGN(BinaryNode binaryNode) {
        if (es6 && (binaryNode.lhs() instanceof ObjectNode || binaryNode.lhs() instanceof LiteralNode.ArrayLiteralNode)) {
