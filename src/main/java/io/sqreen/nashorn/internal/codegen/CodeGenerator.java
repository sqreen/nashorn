...
package io.sqreen.nashorn.internal.codegen;

import static io.sqreen.nashorn.internal.codegen.ClassEmitter.Flag.PRIVATE;
import static io.sqreen.nashorn.internal.codegen.ClassEmitter.Flag.STATIC;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.ARGUMENTS;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.CALLEE;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.CREATE_PROGRAM_FUNCTION;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.GET_MAP;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.GET_STRING;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.QUICK_PREFIX;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.REGEX_PREFIX;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.SCOPE;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.SPLIT_PREFIX;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.THIS;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.VARARGS;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.interfaceCallNoLookup;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.methodDescriptor;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.staticCallNoLookup;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.typeDescriptor;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.virtualCallNoLookup;
import static io.sqreen.nashorn.internal.ir.Symbol.HAS_SLOT;
import static io.sqreen.nashorn.internal.ir.Symbol.IS_INTERNAL;
import static io.sqreen.nashorn.internal.runtime.UnwarrantedOptimismException.INVALID_PROGRAM_POINT;
import static io.sqreen.nashorn.internal.runtime.UnwarrantedOptimismException.isValid;
import static io.sqreen.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_APPLY_TO_CALL;
import static io.sqreen.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_DECLARE;
import static io.sqreen.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_FAST_SCOPE;
import static io.sqreen.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_OPTIMISTIC;
import static io.sqreen.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_PROGRAM_POINT_SHIFT;
import static io.sqreen.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_SCOPE;
...
import io.sqreen.nashorn.internal.parser.TokenType;
import io.sqreen.nashorn.internal.AssertsEnabled;
import io.sqreen.nashorn.internal.IntDeque;
import io.sqreen.nashorn.internal.codegen.ClassEmitter.Flag;
import io.sqreen.nashorn.internal.codegen.CompilerConstants.Call;
import io.sqreen.nashorn.internal.codegen.types.ArrayType;
import io.sqreen.nashorn.internal.codegen.types.Type;
import io.sqreen.nashorn.internal.ir.AccessNode;
import io.sqreen.nashorn.internal.ir.BaseNode;
import io.sqreen.nashorn.internal.ir.BinaryNode;
import io.sqreen.nashorn.internal.ir.Block;
import io.sqreen.nashorn.internal.ir.BlockStatement;
import io.sqreen.nashorn.internal.ir.BreakNode;
import io.sqreen.nashorn.internal.ir.CallNode;
import io.sqreen.nashorn.internal.ir.CaseNode;
import io.sqreen.nashorn.internal.ir.CatchNode;
import io.sqreen.nashorn.internal.ir.ContinueNode;
import io.sqreen.nashorn.internal.ir.EmptyNode;
import io.sqreen.nashorn.internal.ir.Expression;
import io.sqreen.nashorn.internal.ir.ExpressionStatement;
import io.sqreen.nashorn.internal.ir.ForNode;
import io.sqreen.nashorn.internal.ir.FunctionNode;
import io.sqreen.nashorn.internal.ir.GetSplitState;
import io.sqreen.nashorn.internal.ir.IdentNode;
import io.sqreen.nashorn.internal.ir.IfNode;
import io.sqreen.nashorn.internal.ir.IndexNode;
import io.sqreen.nashorn.internal.ir.JoinPredecessorExpression;
import io.sqreen.nashorn.internal.ir.JumpStatement;
import io.sqreen.nashorn.internal.ir.JumpToInlinedFinally;
import io.sqreen.nashorn.internal.ir.LabelNode;
import io.sqreen.nashorn.internal.ir.LexicalContext;
import io.sqreen.nashorn.internal.ir.LexicalContextNode;
import io.sqreen.nashorn.internal.ir.LiteralNode;
import io.sqreen.nashorn.internal.ir.LocalVariableConversion;
import io.sqreen.nashorn.internal.ir.LoopNode;
import io.sqreen.nashorn.internal.ir.Node;
import io.sqreen.nashorn.internal.ir.ObjectNode;
import io.sqreen.nashorn.internal.ir.Optimistic;
import io.sqreen.nashorn.internal.ir.PropertyNode;
import io.sqreen.nashorn.internal.ir.ReturnNode;
import io.sqreen.nashorn.internal.ir.RuntimeNode;
import io.sqreen.nashorn.internal.ir.SetSplitState;
import io.sqreen.nashorn.internal.ir.SplitReturn;
import io.sqreen.nashorn.internal.ir.Splittable;
import io.sqreen.nashorn.internal.ir.Statement;
import io.sqreen.nashorn.internal.ir.SwitchNode;
import io.sqreen.nashorn.internal.ir.Symbol;
import io.sqreen.nashorn.internal.ir.TernaryNode;
import io.sqreen.nashorn.internal.ir.ThrowNode;
import io.sqreen.nashorn.internal.ir.TryNode;
import io.sqreen.nashorn.internal.ir.UnaryNode;
import io.sqreen.nashorn.internal.ir.VarNode;
import io.sqreen.nashorn.internal.ir.WhileNode;
import io.sqreen.nashorn.internal.ir.WithNode;
import io.sqreen.nashorn.internal.ir.visitor.NodeOperatorVisitor;
import io.sqreen.nashorn.internal.ir.visitor.SimpleNodeVisitor;
import io.sqreen.nashorn.internal.objects.Global;
import io.sqreen.nashorn.internal.parser.Lexer.RegexToken;
import io.sqreen.nashorn.internal.runtime.Context;
import io.sqreen.nashorn.internal.runtime.Debug;
import io.sqreen.nashorn.internal.runtime.ECMAException;
import io.sqreen.nashorn.internal.runtime.JSType;
import io.sqreen.nashorn.internal.runtime.OptimisticReturnFilters;
import io.sqreen.nashorn.internal.runtime.PropertyMap;
import io.sqreen.nashorn.internal.runtime.RecompilableScriptFunctionData;
import io.sqreen.nashorn.internal.runtime.RewriteException;
import io.sqreen.nashorn.internal.runtime.Scope;
import io.sqreen.nashorn.internal.runtime.ScriptEnvironment;
import io.sqreen.nashorn.internal.runtime.ScriptFunction;
import io.sqreen.nashorn.internal.runtime.ScriptObject;
import io.sqreen.nashorn.internal.runtime.ScriptRuntime;
import io.sqreen.nashorn.internal.runtime.Source;
import io.sqreen.nashorn.internal.runtime.Undefined;
import io.sqreen.nashorn.internal.runtime.UnwarrantedOptimismException;
import io.sqreen.nashorn.internal.runtime.arrays.ArrayData;
import io.sqreen.nashorn.internal.runtime.linker.LinkerCallSite;
import io.sqreen.nashorn.internal.runtime.logging.DebugLogger;
import io.sqreen.nashorn.internal.runtime.logging.Loggable;
import io.sqreen.nashorn.internal.runtime.logging.Logger;
import io.sqreen.nashorn.internal.runtime.options.Options;
...
final class CodeGenerator extends NodeOperatorVisitor<CodeGeneratorLexicalContext> implements Loggable {
    ...
    private boolean nullCheck(final RuntimeNode runtimeNode, final List<Expression> args) {
        ...
        if (RuntimeNode.Request.isEQ(request)) {
            method.ifnull(!RuntimeNode.Request.isStrict(request) ? popLabel : trueLabel);
            if (!RuntimeNode.Request.isStrict(request)) {
                method.loadUndefined(Type.OBJECT);
            ...
            method.ifnull(!RuntimeNode.Request.isStrict(request) ? popLabel : falseLabel);
            if (!RuntimeNode.Request.isStrict(request)) {
                method.loadUndefined(Type.OBJECT);
    ...
    private abstract class Store<T extends Expression> {
        ...
        private void epilogue() {
             ...
             * very rare. See for example test/nashorn/script/basic/access-specializer.js
             */
            target.accept(new SimpleNodeVisitor() {
                @Override
                protected boolean enterDefault(final Node node) {
    ...
    private MethodEmitter globalAllocateArray(final ArrayType type) {
        ...
        return method.invokestatic(GLOBAL_OBJECT, "allocate", "(" + type.getDescriptor() + ")Lio/sqreen/nashorn/internal/objects/NativeArray;");
    }
