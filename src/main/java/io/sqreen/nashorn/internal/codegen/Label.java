...
public final class Label implements Serializable {
    ...
    private transient io.sqreen.internal.org.objectweb.asm.Label label;
    ...
    io.sqreen.internal.org.objectweb.asm.Label getLabel() {
        if (this.label == null) {
            this.label = new io.sqreen.internal.org.objectweb.asm.Label();
        }
        return label;
    }
