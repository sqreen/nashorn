...
class ObjectType extends Type {
    ...
    public Type loadUndefined(final MethodVisitor method) {
        method.visitFieldInsn(GETSTATIC, CompilerConstants.className(ScriptRuntime.class), "UNDEFINED", CompilerConstants.typeDescriptor(Undefined.class));
        return UNDEFINED;
    }
    ...
    public Type loadEmpty(final MethodVisitor method) {
        method.visitFieldInsn(GETSTATIC, CompilerConstants.className(ScriptRuntime.class), "EMPTY", CompilerConstants.typeDescriptor(Undefined.class));
        return UNDEFINED;
    }
