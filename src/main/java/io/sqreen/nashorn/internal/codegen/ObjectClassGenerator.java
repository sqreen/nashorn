...
import static io.sqreen.nashorn.internal.codegen.Compiler.SCRIPTS_PACKAGE;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.ALLOCATE;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.INIT_ARGUMENTS;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.INIT_MAP;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.INIT_SCOPE;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.JAVA_THIS;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.JS_OBJECT_DUAL_FIELD_PREFIX;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.JS_OBJECT_SINGLE_FIELD_PREFIX;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.className;
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.constructorNoLookup;
import static io.sqreen.nashorn.internal.runtime.JSType.CONVERT_OBJECT;
import static io.sqreen.nashorn.internal.runtime.JSType.CONVERT_OBJECT_OPTIMISTIC;
import static io.sqreen.nashorn.internal.runtime.JSType.GET_UNDEFINED;
import static io.sqreen.nashorn.internal.runtime.JSType.TYPE_DOUBLE_INDEX;
import static io.sqreen.nashorn.internal.runtime.JSType.TYPE_INT_INDEX;
import static io.sqreen.nashorn.internal.runtime.JSType.TYPE_OBJECT_INDEX;
import static io.sqreen.nashorn.internal.runtime.JSType.TYPE_UNDEFINED_INDEX;
import static io.sqreen.nashorn.internal.runtime.JSType.getAccessorTypeIndex;
...
import io.sqreen.nashorn.internal.runtime.AccessorProperty;
import io.sqreen.nashorn.internal.runtime.AllocationStrategy;
import io.sqreen.nashorn.internal.runtime.Context;
import io.sqreen.nashorn.internal.runtime.FunctionScope;
...
public final class ObjectClassGenerator implements Loggable {
    ...
    public static final MethodHandle PACK_DOUBLE =
        Lookup.MH.explicitCastArguments(Lookup.MH.findStatic(MethodHandles.publicLookup(), Double.class, "doubleToRawLongBits", Lookup.MH.type(long.class, double.class)), Lookup.MH.type(long.class, double.class));

    /** double bits to long, used with --dual-fields for primitive double values */
    public static final MethodHandle UNPACK_DOUBLE =
        Lookup.MH.findStatic(MethodHandles.publicLookup(), Double.class, "longBitsToDouble", Lookup.MH.type(double.class, long.class));
    ...
    private static MethodHandle createGetterInner(final Class<?> forType, final Class<?> type, final MethodHandle primitiveGetter, final MethodHandle objectGetter, final List<MethodHandle> converters, final int programPoint) {
        ...
        if (forType == null) {
            if (isOptimistic) {
                ...
                if (ti == TYPE_OBJECT_INDEX) {
                    return Lookup.MH.dropArguments(GET_UNDEFINED.get(TYPE_OBJECT_INDEX), 0, Object.class);
                }
                //throw exception
                return Lookup.MH.asType(
            ...
            return Lookup.MH.dropArguments(GET_UNDEFINED.get(ti), 0, Object.class);
        }
        ...
        if (isOptimistic) {
            if (fti < ti) {
                ...
                if (fti == TYPE_OBJECT_INDEX) {
                    return Lookup.MH.filterReturnValue(
                            objectGetter,
                            Lookup.MH.insertArguments(
                                    converters.get(ti),
                                    1,
        ...
        if (fti == TYPE_OBJECT_INDEX) {
            if (fti != ti) {
                return Lookup.MH.filterReturnValue(tgetter, CONVERT_OBJECT.get(ti));
            }
            return tgetter;
        }
    ...
    public static MethodHandle createGuardBoxedPrimitiveSetter(final Class<?> forType, final MethodHandle primitiveSetter, final MethodHandle objectSetter) {
        ...
        return Lookup.MH.guardWithTest(
            Lookup.MH.insertArguments(
                Lookup.MH.dropArguments(
                    IS_TYPE_GUARD,
                    1,
