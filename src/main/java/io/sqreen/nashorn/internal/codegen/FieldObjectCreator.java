...
public abstract class FieldObjectCreator<T> extends ObjectCreator<T> {
    ...
    private void putField(final MethodEmitter method, final String key, final int fieldIndex, final MapTuple<T> tuple) {
        final Type    fieldType   = codegen.useDualFields() && tuple.isPrimitive() ? ObjectClassGenerator.PRIMITIVE_FIELD_TYPE : Type.OBJECT;
    ...
    private void countFields() {
        ...
        paddedFieldCount = ObjectClassGenerator.getPaddedFieldCount(fieldCount);
    }
