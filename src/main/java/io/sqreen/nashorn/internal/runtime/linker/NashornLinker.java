...
import io.sqreen.nashorn.internal.runtime.AccessControlContextFactory;
import io.sqreen.nashorn.internal.runtime.JSType;
import io.sqreen.nashorn.internal.runtime.ListAdapter;
...
final class NashornLinker implements TypeBasedGuardingDynamicLinker, GuardingTypeConverterFactory, ConversionComparator {
    ...
    public GuardedInvocation convertToType(final Class<?> sourceType, final Class<?> targetType, final Supplier<MethodHandles.Lookup> lookupSupplier) throws Exception {
        ...
        return gi == null ? null : gi.asType(io.sqreen.nashorn.internal.lookup.Lookup.MH.type(targetType, sourceType));
    }
        ...
        if (isSourceTypeNativeArray || isSourceTypeGeneric) {
            ...
            if(targetType.isArray()) {
                ...
                if (mh.type().parameterCount() == 2) {
                    ...
                    mhWithLookup = io.sqreen.nashorn.internal.lookup.Lookup.MH.insertArguments(mh, 1,
    ...
    private static MethodHandle createArrayConverter(final Class<?> type) {
        ...
        final CompilerConstants.Call converterCall;
        ...
        final MethodHandle typeBoundConverter = io.sqreen.nashorn.internal.lookup.Lookup.MH.insertArguments(converterCall.methodHandle(), 1, componentType);
        return io.sqreen.nashorn.internal.lookup.Lookup.MH.asType(typeBoundConverter, typeBoundConverter.type().changeReturnType(type));
    }
    ...
    private static final MethodHandle IS_SCRIPT_OBJECT = Guards.isInstance(ScriptObject.class, io.sqreen.nashorn.internal.lookup.Lookup.MH.type(Boolean.TYPE, Object.class));
    private static final MethodHandle IS_FUNCTION = findOwnMH("isFunction", boolean.class, Object.class);
    private static final MethodHandle IS_NATIVE_ARRAY = Guards.isOfClass(NativeArray.class, io.sqreen.nashorn.internal.lookup.Lookup.MH.type(Boolean.TYPE, Object.class));
    ...
    private static MethodHandle findOwnMH(final String name, final Class<?> rtype, final Class<?>... types) {
        return io.sqreen.nashorn.internal.lookup.Lookup.MH.findStatic(MethodHandles.lookup(), NashornLinker.class, name, io.sqreen.nashorn.internal.lookup.Lookup.MH.type(rtype, types));
    }
}
