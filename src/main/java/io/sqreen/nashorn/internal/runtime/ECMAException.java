...
import static io.sqreen.nashorn.internal.codegen.CompilerConstants.virtualField;
...
public final class ECMAException extends NashornException {
     ...
     */
    public static final CompilerConstants.Call CREATE = CompilerConstants.staticCallNoLookup(ECMAException.class, "create", ECMAException.class, Object.class, String.class, int.class, int.class);
