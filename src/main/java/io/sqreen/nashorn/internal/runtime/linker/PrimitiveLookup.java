 ...
 * numbers). This class is only public so it can be accessed by classes in the {@code io.sqreen.nashorn.internal.objects}
 * package.
 */
public final class PrimitiveLookup {
    ...
    private static final MethodHandle PRIMITIVE_SETTER = findOwnMH("primitiveSetter",
            Lookup.MH.type(void.class, ScriptObject.class, Object.class, Object.class, boolean.class, Object.class));
