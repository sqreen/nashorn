...
import io.sqreen.nashorn.internal.lookup.MethodHandleFunctionality;
...
public final class RewriteException extends Exception {
    ...
    public static final CompilerConstants.Call GET_PROGRAM_POINT        = CompilerConstants.virtualCallNoLookup(RewriteException.class, "getProgramPoint", int.class);
    /** Call for getting the return value for the exception */
    public static final CompilerConstants.Call GET_RETURN_VALUE         = CompilerConstants.virtualCallNoLookup(RewriteException.class, "getReturnValueDestructive", Object.class);
    /** Call for the populate array bootstrap */
    public static final CompilerConstants.Call BOOTSTRAP                = CompilerConstants.staticCallNoLookup(RewriteException.class, "populateArrayBootstrap", CallSite.class, Lookup.class, String.class, MethodType.class, int.class);

    /** Call for populating an array with local variable state */
    private static final CompilerConstants.Call POPULATE_ARRAY           = CompilerConstants.staticCall(MethodHandles.lookup(), RewriteException.class, "populateArray", Object[].class, Object[].class, int.class, Object[].class);
    ...
    public static final CompilerConstants.Call ASSERT_ARRAY_LENGTH = CompilerConstants.staticCallNoLookup(RewriteException.class, "assertArrayLength", void.class, Object[].class, int.class);
