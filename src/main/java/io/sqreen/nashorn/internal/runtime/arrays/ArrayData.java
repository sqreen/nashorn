...
public abstract class ArrayData {
     ...
     * of the wrong type
     */
    protected static final CompilerConstants.Call THROW_UNWARRANTED = CompilerConstants.staticCall(MethodHandles.lookup(), ArrayData.class, "throwUnwarranted", void.class, ArrayData.class, int.class, int.class);
