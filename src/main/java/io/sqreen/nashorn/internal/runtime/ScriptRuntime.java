...
import static io.sqreen.nashorn.internal.runtime.ECMAErrors.syntaxError;
import static io.sqreen.nashorn.internal.runtime.ECMAErrors.typeError;
import static io.sqreen.nashorn.internal.runtime.JSType.isRepresentableAsInt;
...
import io.sqreen.nashorn.internal.ir.debug.JSONWriter;
import io.sqreen.nashorn.internal.objects.AbstractIterator;
import io.sqreen.nashorn.internal.objects.Global;
import io.sqreen.nashorn.internal.objects.NativeObject;
import io.sqreen.nashorn.internal.objects.NativeJava;
...
public final class ScriptRuntime {
    ...
    /** Method handle to generic === operator, operating on objects */
    public static final CompilerConstants.Call EQ_STRICT = CompilerConstants.staticCallNoLookup(ScriptRuntime.class, "EQ_STRICT", boolean.class, Object.class, Object.class);
     ...
     */
    public static final CompilerConstants.Call THROW_REFERENCE_ERROR = CompilerConstants.staticCall(MethodHandles.lookup(), ScriptRuntime.class, "throwReferenceError", void.class, String.class);

    /**
     * Throws a reference error for an undefined variable.
     */
    public static final CompilerConstants.Call THROW_CONST_TYPE_ERROR = CompilerConstants.staticCall(MethodHandles.lookup(), ScriptRuntime.class, "throwConstTypeError", void.class, String.class);
     ...
     */
    public static final CompilerConstants.Call INVALIDATE_RESERVED_BUILTIN_NAME = CompilerConstants.staticCallNoLookup(ScriptRuntime.class, "invalidateReservedBuiltinName", void.class, String.class);

    /**
     * Used to perform failed delete under strict mode
     */
    public static final CompilerConstants.Call STRICT_FAIL_DELETE = CompilerConstants.staticCallNoLookup(ScriptRuntime.class, "strictFailDelete", boolean.class, String.class);

    /**
     * Used to find the scope for slow delete
     */
    public static final CompilerConstants.Call SLOW_DELETE = CompilerConstants.staticCallNoLookup(ScriptRuntime.class, "slowDelete", boolean.class, ScriptObject.class, String.class);
    ...
    public static Object ADD(final Object x, final Object y) {
        ...
        if (JSType.isString(xPrim) || JSType.isString(yPrim)) {
            try {
                ...
                throw ECMAErrors.rangeError(iae, "concat.string.too.big");
            }
        }
