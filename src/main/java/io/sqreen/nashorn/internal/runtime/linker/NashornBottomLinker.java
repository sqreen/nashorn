...
final class NashornBottomLinker implements GuardingDynamicLinker, GuardingTypeConverterFactory {
    ...
    private static final MethodHandle EMPTY_PROP_GETTER =
            io.sqreen.nashorn.internal.lookup.Lookup.MH.dropArguments(io.sqreen.nashorn.internal.lookup.Lookup.MH.constant(Object.class, ScriptRuntime.UNDEFINED), 0, Object.class);
    private static final MethodHandle EMPTY_ELEM_GETTER =
            io.sqreen.nashorn.internal.lookup.Lookup.MH.dropArguments(EMPTY_PROP_GETTER, 0, Object.class);
    private static final MethodHandle EMPTY_PROP_SETTER =
            io.sqreen.nashorn.internal.lookup.Lookup.MH.asType(EMPTY_ELEM_GETTER, EMPTY_ELEM_GETTER.type().changeReturnType(void.class));
    private static final MethodHandle EMPTY_ELEM_SETTER =
            io.sqreen.nashorn.internal.lookup.Lookup.MH.dropArguments(EMPTY_PROP_SETTER, 0, Object.class);
    ...
    private static GuardedInvocation linkNull(final LinkRequest linkRequest) {
        ...
        case GET:
            throw ECMAErrors.typeError(NashornCallSiteDescriptor.isMethodFirstOperation(desc) ? "no.such.function" : "cant.get.property", getArgument(linkRequest), "null");
        case SET:
