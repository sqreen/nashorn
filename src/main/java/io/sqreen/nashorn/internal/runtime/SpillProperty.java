...
public class SpillProperty extends AccessorProperty {
    ...
    private static class Accessors {
        ...
        MethodHandle getOrCreate(final boolean isPrimitive, final boolean isGetter) {
            ...
            accessor = Lookup.MH.insertArguments(accessor, 1, slot);
            if (!isGetter) {
                accessor = Lookup.MH.filterArguments(accessor, 0, ensureSpillSize);
            }
    ...
    private static MethodHandle primitiveGetter(final int slot, final int flags) {
        return (flags & io.sqreen.nashorn.internal.runtime.Property.DUAL_FIELDS) == io.sqreen.nashorn.internal.runtime.Property.DUAL_FIELDS ? Accessors.getCached(slot, true, true) : null;
    }
    private static MethodHandle primitiveSetter(final int slot, final int flags) {
        return (flags & io.sqreen.nashorn.internal.runtime.Property.DUAL_FIELDS) == io.sqreen.nashorn.internal.runtime.Property.DUAL_FIELDS ? Accessors.getCached(slot, true, false) : null;
    }
