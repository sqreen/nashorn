...
package io.sqreen.nashorn.internal.runtime;

import static io.sqreen.nashorn.internal.runtime.ECMAErrors.typeError;
...
import io.sqreen.nashorn.internal.lookup.Lookup;
import io.sqreen.nashorn.internal.objects.Global;
import io.sqreen.nashorn.internal.objects.NativeSymbol;
import io.sqreen.nashorn.internal.parser.Lexer;
import jdk.dynalink.SecureLookupSupplier;
import jdk.dynalink.beans.StaticClass;
import io.sqreen.nashorn.api.scripting.JSObject;
import io.sqreen.nashorn.internal.codegen.types.Type;
import io.sqreen.nashorn.internal.runtime.arrays.ArrayLikeIterator;
import io.sqreen.nashorn.internal.runtime.doubleconv.DoubleConversion;
...
public enum JSType {
    ...
    public static final CompilerConstants.Call TO_BOOLEAN = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toBoolean", boolean.class, Object.class);

    /** JavaScript compliant conversion function from number to boolean */
    public static final CompilerConstants.Call TO_BOOLEAN_D = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toBoolean", boolean.class, double.class);

    /** JavaScript compliant conversion function from int to boolean */
    public static final CompilerConstants.Call TO_BOOLEAN_I = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toBoolean", boolean.class, int.class);

    /** JavaScript compliant conversion function from Object to integer */
    public static final CompilerConstants.Call TO_INTEGER = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toInteger", int.class, Object.class);

    /** JavaScript compliant conversion function from Object to long */
    public static final CompilerConstants.Call TO_LONG = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toLong", long.class, Object.class);

    /** JavaScript compliant conversion function from double to long */
    public static final CompilerConstants.Call TO_LONG_D = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toLong", long.class, double.class);

    /** JavaScript compliant conversion function from Object to number */
    public static final CompilerConstants.Call TO_NUMBER = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toNumber", double.class, Object.class);

    /** JavaScript compliant conversion function from Object to number with type check */
    public static final CompilerConstants.Call TO_NUMBER_OPTIMISTIC = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toNumberOptimistic", double.class, Object.class, int.class);
    ...
    public static final CompilerConstants.Call TO_INT32 = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toInt32", int.class, Object.class);

    /** JavaScript compliant conversion function from Object to int32 */
    public static final CompilerConstants.Call TO_INT32_L = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toInt32", int.class, long.class);

    /** JavaScript compliant conversion function from Object to int32 with type check */
    public static final CompilerConstants.Call TO_INT32_OPTIMISTIC = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toInt32Optimistic", int.class, Object.class, int.class);

    /** JavaScript compliant conversion function from double to int32 */
    public static final CompilerConstants.Call TO_INT32_D = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toInt32", int.class, double.class);

    /** JavaScript compliant conversion function from int to uint32 */
    public static final CompilerConstants.Call TO_UINT32_OPTIMISTIC = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toUint32Optimistic", int.class, int.class, int.class);

    /** JavaScript compliant conversion function from int to uint32 */
    public static final CompilerConstants.Call TO_UINT32_DOUBLE = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toUint32Double", double.class, int.class);

    /** JavaScript compliant conversion function from Object to uint32 */
    public static final CompilerConstants.Call TO_UINT32 = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toUint32", long.class, Object.class);

    /** JavaScript compliant conversion function from number to uint32 */
    public static final CompilerConstants.Call TO_UINT32_D = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toUint32", long.class, double.class);

    /** JavaScript compliant conversion function from number to String */
    public static final CompilerConstants.Call TO_STRING_D = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toString", String.class, double.class);
    ...
    public static final CompilerConstants.Call THROW_UNWARRANTED = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "throwUnwarrantedOptimismException", Object.class, Object.class, int.class);

    /** Add exact wrapper for potentially overflowing integer operations */
    public static final CompilerConstants.Call ADD_EXACT       = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "addExact", int.class, int.class, int.class, int.class);

    /** Sub exact wrapper for potentially overflowing integer operations */
    public static final CompilerConstants.Call SUB_EXACT       = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "subExact", int.class, int.class, int.class, int.class);

    /** Multiply exact wrapper for potentially overflowing integer operations */
    public static final CompilerConstants.Call MUL_EXACT       = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "mulExact", int.class, int.class, int.class, int.class);

    /** Div exact wrapper for potentially integer division that turns into float point */
    public static final CompilerConstants.Call DIV_EXACT       = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "divExact", int.class, int.class, int.class, int.class);

    /** Div zero wrapper for integer division that handles (0/0)|0 == 0 */
    public static final CompilerConstants.Call DIV_ZERO        = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "divZero", int.class, int.class, int.class);

    /** Mod zero wrapper for integer division that handles (0%0)|0 == 0 */
    public static final CompilerConstants.Call REM_ZERO        = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "remZero", int.class, int.class, int.class);

    /** Mod exact wrapper for potentially integer remainders that turns into float point */
    public static final CompilerConstants.Call REM_EXACT       = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "remExact", int.class, int.class, int.class, int.class);

    /** Decrement exact wrapper for potentially overflowing integer operations */
    public static final CompilerConstants.Call DECREMENT_EXACT = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "decrementExact",   int.class, int.class, int.class);

    /** Increment exact wrapper for potentially overflowing integer operations */
    public static final CompilerConstants.Call INCREMENT_EXACT = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "incrementExact",   int.class, int.class, int.class);

    /** Negate exact exact wrapper for potentially overflowing integer operations */
    public static final CompilerConstants.Call NEGATE_EXACT         = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "negateExact", int.class, int.class, int.class);
    ...
    /** Method handle to convert a JS Object to a Java array. */
    public static final CompilerConstants.Call TO_JAVA_ARRAY_WITH_LOOKUP = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toJavaArrayWithLookup", Object.class, Object.class, Class.class, SecureLookupSupplier.class);

    /** Method handle for void returns. */
    public static final CompilerConstants.Call VOID_RETURN = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "voidReturn", void.class);

    /** Method handle for isString method */
    public static final CompilerConstants.Call IS_STRING = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "isString", boolean.class, Object.class);

    /** Method handle for isNumber method */
    public static final CompilerConstants.Call IS_NUMBER = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "isNumber", boolean.class, Object.class);
    ...
    public static final List<MethodHandle> GET_UNDEFINED = toUnmodifiableList(
        Lookup.MH.constant(int.class, UNDEFINED_INT),
        Lookup.MH.constant(double.class, UNDEFINED_DOUBLE),
        Lookup.MH.constant(Object.class, Undefined.getUndefined())
    );
    ...
    */
    ...
    static String toStringImpl(final Object obj, final boolean safe) {
        ...
        if (obj instanceof Symbol) {
            ...
            throw ECMAErrors.typeError("symbol.to.string");
        }
    ...
    private static double toNumberGeneric(final Object obj) {
        ...
        if (obj instanceof Symbol) {
            throw ECMAErrors.typeError("symbol.to.number");
        }
