...
public final class GlobalFunctions {
    ...
    public static final MethodHandle PARSEINT_Z = Lookup.MH.dropArguments(Lookup.MH.dropArguments(Lookup.MH.constant(double.class, Double.NaN), 0, boolean.class), 0, Object.class);

    /** ParseInt - identity for ints */
    public static final MethodHandle PARSEINT_I = Lookup.MH.dropArguments(Lookup.MH.identity(int.class), 0, Object.class);
    ...
    public static final MethodHandle IS_NAN_I = Lookup.MH.dropArguments(Lookup.MH.constant(boolean.class, false), 0, Object.class);

    /** isNan for longs - always false */
    public static final MethodHandle IS_NAN_J = Lookup.MH.dropArguments(Lookup.MH.constant(boolean.class, false), 0, Object.class);

    /** IsNan for doubles - use Double.isNaN */
    public static final MethodHandle IS_NAN_D = Lookup.MH.dropArguments(Lookup.MH.findStatic(MethodHandles.lookup(), Double.class, "isNaN", Lookup.MH.type(boolean.class, double.class)), 0, Object.class);
