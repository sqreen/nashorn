...
import static io.sqreen.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.getProgramPoint;
...
public final class GlobalConstants implements Loggable {
    ...
    private static final MethodHandle RECEIVER_GUARD = CompilerConstants.staticCall(LOOKUP, GlobalConstants.class, "receiverGuard", boolean.class, Access.class, Object.class, Object.class).methodHandle();
    ...
    GuardedInvocation findSetMethod(final FindProperty find, final ScriptObject receiver, final GuardedInvocation inv, final CallSiteDescriptor desc, final LinkRequest request) {
        ...
        synchronized (this) {
            ...
            final MethodHandle boundInvalidator = Lookup.MH.bindTo(INVALIDATE_SP,  this);
    ...
    GuardedInvocation findGetMethod(final FindProperty find, final ScriptObject receiver, final CallSiteDescriptor desc) {
        ...
        final int      programPoint = isOptimistic ? getProgramPoint(desc) : UnwarrantedOptimismException.INVALID_PROGRAM_POINT;
