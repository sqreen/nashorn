...
public final class Undefined extends DefaultPropertyAccess {
    ...
    private static final MethodHandle SET_METHOD = Lookup.MH.insertArguments(findOwnMH("set", void.class, Object.class, Object.class, int.class), 3, NashornCallSiteDescriptor.CALLSITE_STRICT);
    private static final MethodHandle DELETE_METHOD = Lookup.MH.insertArguments(findOwnMH("delete", boolean.class, Object.class, boolean.class), 2, false);
