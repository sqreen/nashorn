...
/**
 * Test for nashorn Parser API (io.sqreen.nashorn.api.tree.*)
 *
 * @test
 * @run testng io.sqreen.nashorn.api.tree.test.ParseAPITest
 */
public class ParseAPITest {
    ...
    static {
        final String testScriptDir = "test/nashorn/script/";
