 ...
 *
 * @test
 * @build io.sqreen.nashorn.api.scripting.test.VariableArityTestInterface io.sqreen.nashorn.api.scripting.test.InvocableTest
 * @run testng io.sqreen.nashorn.api.scripting.test.InvocableTest
 */
...
public class InvocableTest {
    ...
    public void variableArityInterfaceTest() throws ScriptException {
        ...
        assertEquals(itf.test1(42, "a", "b"), "i == 42, strings instanceof java.lang.String[] == true, strings == [a, b]");
        assertEquals(itf.test2(44, "c", "d", "e"), "arguments[0] == 44, arguments[1] instanceof java.lang.String[] == true, arguments[1] == [c, d, e]");
    }
