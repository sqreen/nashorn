...
package io.sqreen.nashorn.api.scripting.test;
 ...
 *
 * @test
 * @build io.sqreen.nashorn.api.scripting.test.Window io.sqreen.nashorn.api.scripting.test.WindowEventHandler io.sqreen.nashorn.api.scripting.test.VariableArityTestInterface io.sqreen.nashorn.api.scripting.test.ScriptEngineTest
 * @run testng/othervm io.sqreen.nashorn.api.scripting.test.ScriptEngineTest
 */
...
public class ScriptEngineTest {
    ...
    public void scriptObjectAutoConversionTest() throws ScriptException {
        ...
        e.put("Window", e.eval("Packages.io.sqreen.nashorn.api.scripting.test.Window"));
