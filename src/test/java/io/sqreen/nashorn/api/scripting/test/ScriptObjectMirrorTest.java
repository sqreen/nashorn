...
/**
 * Tests to check io.sqreen.nashorn.api.scripting.ScriptObjectMirror API.
 *
 * @test
 * @run testng io.sqreen.nashorn.api.scripting.test.ScriptObjectMirrorTest
 */
...
public class ScriptObjectMirrorTest {
    ...
    public void conversionTest() throws ScriptException {
        ...
        assertEquals(42.0d, (double) obj.to(Double.class));
    ...
    public void mirrorUnwrapInterfaceMethod() throws Exception {
        ...
        engine.eval("function apply(obj) { " +
            " return obj instanceof Packages.io.sqreen.nashorn.api.scripting.ScriptObjectMirror; " +
            "}");
        @SuppressWarnings("unchecked")
