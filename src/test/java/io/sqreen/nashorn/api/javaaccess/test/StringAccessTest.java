...
/**
 * @test
 * @build io.sqreen.nashorn.api.javaaccess.test.SharedObject io.sqreen.nashorn.api.javaaccess.test.Person io.sqreen.nashorn.api.javaaccess.test.StringAccessTest
 * @run testng/othervm io.sqreen.nashorn.api.javaaccess.test.StringAccessTest
 */
