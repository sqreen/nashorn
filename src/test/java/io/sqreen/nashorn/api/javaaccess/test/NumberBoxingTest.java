...
/**
 * @test
 * @build io.sqreen.nashorn.api.javaaccess.test.SharedObject io.sqreen.nashorn.api.javaaccess.test.Person io.sqreen.nashorn.api.javaaccess.test.NumberBoxingTest
 * @run testng/othervm io.sqreen.nashorn.api.javaaccess.test.NumberBoxingTest
 */
