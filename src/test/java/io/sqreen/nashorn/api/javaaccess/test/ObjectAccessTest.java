...
package io.sqreen.nashorn.api.javaaccess.test;
...
/**
 * @test
 * @build io.sqreen.nashorn.api.javaaccess.test.SharedObject io.sqreen.nashorn.api.javaaccess.test.Person io.sqreen.nashorn.api.javaaccess.test.ObjectAccessTest
 * @run testng/othervm io.sqreen.nashorn.api.javaaccess.test.ObjectAccessTest
 */
...
public class ObjectAccessTest {
    ...
    public static void setUpClass() throws ScriptException {
        ...
        o = new SharedObject();
        e.put("o", o);
        e.eval("var SharedObject = Packages.io.sqreen.nashorn.api.javaaccess.test.SharedObject;");
        e.eval("var Person = Packages.io.sqreen.nashorn.api.javaaccess.test.Person;");
    }
    ...
    public void accessFieldObjectArray() throws ScriptException {
        ...
        e.eval("var t_object_arr = new (Java.type(\"io.sqreen.nashorn.api.javaaccess.test.Person[]\"))(3);" +
    ...
    public void accessStaticFieldObjectArray() throws ScriptException {
        ...
        e.eval("var ts_object_arr = new (Java.type(\"io.sqreen.nashorn.api.javaaccess.test.Person[]\"))(3);" +
    ...
    public void accessFinalFieldObjectArray() throws ScriptException {
        ...
        e.eval("var tf_object_arr = new (Java.type(\"io.sqreen.nashorn.api.javaaccess.test.Person[]\"))(3);" +
    ...
    public void accessStaticFinalFieldObjectArray() throws ScriptException {
        ...
        e.eval("var tsf_object_arr = new (Java.type(\"io.sqreen.nashorn.api.javaaccess.test.Person[]\"))(3);" +
