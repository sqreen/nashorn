...
/**
 * @test
 * @build io.sqreen.nashorn.api.javaaccess.test.SharedObject io.sqreen.nashorn.api.javaaccess.test.Person io.sqreen.nashorn.api.javaaccess.test.MethodAccessTest
 * @run testng/othervm io.sqreen.nashorn.api.javaaccess.test.MethodAccessTest
 */
...
public class MethodAccessTest {
    ...
    public void accessDefaultConstructor() throws ScriptException {
        e.eval("var dc = new Packages.io.sqreen.nashorn.api.javaaccess.test.Person()");
        assertEquals(new Person(), e.get("dc"));
    }

    @Test
    public void accessCustomConstructor() throws ScriptException {
        e.eval("var cc = new Packages.io.sqreen.nashorn.api.javaaccess.test.Person(17)");
