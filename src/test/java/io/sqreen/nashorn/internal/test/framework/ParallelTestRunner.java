...
public class ParallelTestRunner {
    ...
    private void suite() throws Exception {
        ...
        final TestFinder.TestFactory<ScriptRunnable> testFactory = new TestFinder.TestFactory<ScriptRunnable>() {
            @Override
    ...
    public boolean run() throws IOException {
        ...
        final String failedList = System.getProperty(TestConfig.TEST_FAILED_LIST_FILE);
    ...
    private static void parseArgs(final String[] args) {
        if (args.length > 0) {
            ...
            if (!roots.isEmpty()) {
                System.setProperty(TestConfig.TEST_JS_ROOTS, roots.trim());
            }
            if (!reportFile.isEmpty()) {
    ...
    private static void setTest262Properties() throws IOException {
        System.setProperty(TestConfig.TEST_JS_ROOTS, "test/nashorn/script/external/test262/test/suite/");
        System.setProperty(TestConfig.TEST_JS_FRAMEWORK, "test/nashorn/script/test262.js test/nashorn/script/external/test262/test/harness/framework.js test/nashorn/script/external/test262/test/harness/sta.js");
        System.setProperty(TestConfig.TEST_JS_EXCLUDES_FILE, "test/nashorn/script/external/test262/test/config/excludelist.xml");
        ...
        System.setProperty(TestConfig.TEST_JS_EXCLUDE_LIST, excludeList);
    }
