...
/*    @Test
    ...
    public void genericTest(final String benchmark) {
        try {
            final String mainScript      = "test/nashorn/script/basic/run-octane.js";
            final String benchmarkScript = benchmark.toLowerCase();
            final String[] args = {
                "--",
                benchmarkScript,
                "--verbose"
            ...
            Double v8Score = null;
            if (checkV8Presence()) {
                v8Score = genericV8Test(benchmark, "test/nashorn/script/basic/run-octane.js -- test/nashorn/script/external/octane/benchmarks/" + benchmark.toLowerCase() + ".js --verbose");
            }
