...
package io.sqreen.nashorn.internal.performance;
...
public class PerformanceWrapper extends io.sqreen.nashorn.tools.Shell {
...
//      System.out.println("overridableRun finished");
    ...
    protected Object apply(final ScriptFunction target, final Object self) {
        if (_runsPerIteration == 0 && _numberOfIterations == 0) {
            final Global global = io.sqreen.nashorn.internal.runtime.Context.getGlobal();
