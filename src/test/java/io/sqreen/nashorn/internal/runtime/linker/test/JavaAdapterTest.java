 ...
 * questions.
 */
package io.sqreen.nashorn.internal.runtime.linker.test;
...
import io.sqreen.nashorn.api.scripting.NashornScriptEngine;
import io.sqreen.nashorn.api.scripting.NashornScriptEngineFactory;
...
public class JavaAdapterTest {
    ...
    public static void testMirrorAdapter() throws ScriptException {
        ...
        e.eval("function convertParamFromEngineScope(){ return Java.type('io.sqreen.nashorn.internal.runtime.linker.test.JavaAdapterTest').m(f);}", e.getBindings(ScriptContext.ENGINE_SCOPE));
        e.eval("function convertParamFromGlobalScope(){ return Java.type('io.sqreen.nashorn.internal.runtime.linker.test.JavaAdapterTest').m(f);}", e.getBindings(ScriptContext.GLOBAL_SCOPE));
