...
package io.sqreen.nashorn.internal.runtime.doubleconv.test;
 ...
 *
 * @test
 * @modules jdk.scripting.nashorn/io.sqreen.nashorn.internal.runtime.doubleconv:open
 * @run testng io.sqreen.nashorn.internal.runtime.doubleconv.test.IeeeDoubleTest
 */
...
public class IeeeDoubleTest {
    ...
    static {
        try {
            final Class<?> IeeeDouble = Class.forName("io.sqreen.nashorn.internal.runtime.doubleconv.IeeeDouble");
            final Class DiyFp = Class.forName("io.sqreen.nashorn.internal.runtime.doubleconv.DiyFp");
