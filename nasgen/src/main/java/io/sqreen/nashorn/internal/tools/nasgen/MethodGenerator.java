...
package io.sqreen.nashorn.internal.tools.nasgen;

import static io.sqreen.internal.org.objectweb.asm.Opcodes.AALOAD;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.AASTORE;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.ACC_STATIC;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.ACONST_NULL;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.ALOAD;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.ANEWARRAY;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.ARETURN;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.ASTORE;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.BALOAD;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.BASTORE;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.BIPUSH;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.CALOAD;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.CASTORE;
...
import static io.sqreen.internal.org.objectweb.asm.Opcodes.FALOAD;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.FASTORE;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.FCONST_0;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.FRETURN;
...
import static io.sqreen.internal.org.objectweb.asm.Opcodes.LCONST_0;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.LRETURN;
...
import static io.sqreen.internal.org.objectweb.asm.Opcodes.SALOAD;
import static io.sqreen.internal.org.objectweb.asm.Opcodes.SASTORE;
...
public class MethodGenerator extends MethodVisitor {
    ...
    static final Type EMPTY_LINK_LOGIC_TYPE = Type.getType("L" + StringConstants.OBJ_ANNO_PKG + "SpecializedFunction$LinkLogic$Empty;");
    ...
    void memberInfoArray(final String className, final List<MemberInfo> mis) {
        ...
        int pos = 0;
        push(mis.size());
        newObjectArray(StringConstants.SPECIALIZATION_TYPE);
        for (final MemberInfo mi : mis) {
            dup();
            push(pos++);
            visitTypeInsn(NEW, StringConstants.SPECIALIZATION_TYPE);
            dup();
            ...
            final String  ctor           = linkLogic ? StringConstants.SPECIALIZATION_INIT3 : StringConstants.SPECIALIZATION_INIT2;
            if (linkLogic) {
                visitLdcInsn(linkLogicClass);
            }
            visitInsn(mi.isOptimistic() ? ICONST_1 : ICONST_0);
            visitInsn(mi.convertsNumericArgs() ? ICONST_1 : ICONST_0);
            visitMethodInsn(INVOKESPECIAL, StringConstants.SPECIALIZATION_TYPE, StringConstants.INIT, ctor, false);
            arrayStore(StringConstants.TYPE_SPECIALIZATION);
        }
    }
