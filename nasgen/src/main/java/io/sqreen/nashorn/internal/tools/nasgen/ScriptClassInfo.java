...
public final class ScriptClassInfo {
    ...
    static final String SCRIPT_CLASS_ANNO_DESC  = getTypeDescriptor(StringConstants.OBJ_ANNO_PKG, "ScriptClass");
    static final String CONSTRUCTOR_ANNO_DESC   = getTypeDescriptor(StringConstants.OBJ_ANNO_PKG, "Constructor");
    static final String FUNCTION_ANNO_DESC      = getTypeDescriptor(StringConstants.OBJ_ANNO_PKG, "Function");
    static final String GETTER_ANNO_DESC        = getTypeDescriptor(StringConstants.OBJ_ANNO_PKG, "Getter");
    static final String SETTER_ANNO_DESC        = getTypeDescriptor(StringConstants.OBJ_ANNO_PKG, "Setter");
    static final String PROPERTY_ANNO_DESC      = getTypeDescriptor(StringConstants.OBJ_ANNO_PKG, "Property");
    static final String WHERE_ENUM_DESC         = getTypeDescriptor(StringConstants.OBJ_ANNO_PKG, "Where");
    static final String LINK_LOGIC_DESC         = getTypeDescriptor(StringConstants.OBJ_ANNO_PKG, "SpecializedFunction$LinkLogic");
    static final String SPECIALIZED_FUNCTION    = getTypeDescriptor(StringConstants.OBJ_ANNO_PKG, "SpecializedFunction");
